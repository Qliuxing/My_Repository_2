...
void ITC2_ZC_BLANK_COMP (void)      __attribute__((weak,alias("_unexpected_interrupt")));
void ITC2_ZC_BLANK_ZC_MASKED (void) __attribute__((weak,alias("_unexpected_interrupt")));
...
const L2_HandlerType L2_vector_table[] __attribute__((used, section(".L2_vectors"))) =
{
    ...
    &ITC2_ZC_BLANK_COMP,        /* connected to EXT1_IT */
    &ITC2_ZC_BLANK_ZC_MASKED
};
