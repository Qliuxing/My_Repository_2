...
#define ITC1_ZCBLANK_INT_ENABLE(p)  EXT1_INT_ENABLE(p)
...
/* ITC1_ZCBLANK_INT dispatcher (EXT1_IT) */
#define ITC2_ZC_BLANK_COMP_ENABLE()             __L2_INT_ENABLE( ZC_BLANK_PEND, ZC_BLANK_MASK, 0)
#define ITC2_ZC_BLANK_COMP_DISABLE()            __L2_INT_DISABLE(ZC_BLANK_PEND, ZC_BLANK_MASK, 0)
#define ITC2_ZC_BLANK_COMP_ACKNOWLEDGE()        __L2_INT_CLEAR(  ZC_BLANK_PEND, ZC_BLANK_MASK, 0)

#define ITC2_ZC_BLANK_ZC_MASKED_ENABLE()        __L2_INT_ENABLE( ZC_BLANK_PEND, ZC_BLANK_MASK, 1)
#define ITC2_ZC_BLANK_ZC_MASKED_DISABLE()       __L2_INT_DISABLE(ZC_BLANK_PEND, ZC_BLANK_MASK, 1)
#define ITC2_ZC_BLANK_ZC_MASKED_ACKNOWLEDGE()   __L2_INT_CLEAR(  ZC_BLANK_PEND, ZC_BLANK_MASK, 1)
...
/* connected to ITC1_ZCBLANK_INT dispatcher (EXT1_IT) */
extern void ITC2_ZC_BLANK_COMP (void);
extern void ITC2_ZC_BLANK_ZC_MASKED (void);
