...
#define C_DEFAULT_NAD						0x16U								/* Default (unprogrammed) NAD */
...
/* Supplier ID */
#define C_WILDCARD_SUPPLIER_ID				0x7FFFU
#define C_YC_SUPPLIER_ID					0x0013U
#define C_MLX_SUPPLIER_ID					((('M'-'@')<<10) | (('L'-'@')<<5) | ('X'-'@'))	/* MeLeXis (test) */
#define C_SUPPLIER_ID						C_YC_SUPPLIER_ID

/* Function ID */
#define C_WILDCARD_FUNCTION_ID				0xFFFFU
#define C_YC_FUNCTION_ID					0x0013U
...
#define C_FUNCTION_ID						C_YC_FUNCTION_ID					/* Function-ID for an Actuator */
#endif /* (_SUPPORT_HVAC_GROUP_ADDRESS != FALSE) */								/* MMP150125-1 - End */
...
#define mlxCONTROL							0xC4U								/* Actuator Control Frame-ID */
#define mlxSTATUS							0x03U								/* Actuator Status Frame-ID */
#if (_SUPPORT_HVAC_GROUP_ADDRESS != FALSE)										/* MMP150125-1 - Begin */
...
typedef struct _ACT_CTRL							/* Description of ACT_CONTROL LIN-Frame */
{
	...
	#define C_CTRL_STALL_ENABLE			1U
		...
		uint8 byReserved3			: 8;							/* Byte 3 */
		uint8 byReserved4			: 8;							/* Byte 4 */
		uint8 byReserved5			: 8;							/* Byte 5 */
		uint8 byReserved6			: 8;							/* Byte 6 */
		uint8 byReserved7			: 8;							/* Byte 7 */
} ACT_CTRL;	
