...
#define ADC_CH4     ( 4u << 8)	/* VS_FILT, Output of the VS Supply Sensor (=VS/14) after filtering */
...
#ifdef __MLX81300_D__
#define UVPM				(1u << 7)	/* Driver configuration at UV: 0 = Tri-state, 1 = To Ground */
#define OVPM				(1u << 6)	/* Driver configuration at OV: 0 = To Ground, 1 = Tri-state */
#endif
