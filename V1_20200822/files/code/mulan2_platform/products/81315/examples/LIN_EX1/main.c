 ...
 *
 * Notes:
 *  1. Generates PWM waveform on pin W (PWM2) with frequency equal to FPLL/1000 =
 *     = 28MHz/1000 = 28 KHz to check RC oscillator trimming
 *     and PLL activation/stability. Duty cycle is 25%.
 *
