...
#include "lib_mlx813xx_bist.h"

volatile uint16 bistHeader __attribute__((section(".bist_stat")));
volatile uint16 bistResetInfo __attribute__((section(".bist_stat")));
volatile uint16 bistError     __attribute__((section(".bist_stat")));
volatile uint16 bistErrorInfo __attribute__((section(".bist_stat")));
