...
/*
 * Timer1 interrupt handlers (connected to 2nd level interrupt controller)
 */
#include <syslib.h>
#include <itc2.h>

#define XI_PEND_REG         SPI_TIMERS_IRQ_STAT     /* bits [7:3]        */
#define XI_MASK_REG         SPI_TIMERS_IRQ_MASK     /* bits [7:3]        */
#define XI_BASE_BIT         3                       /* starts from bit 3 */
#define XI_POSITION_MASK    (0x1Fu << XI_BASE_BIT)  /* bits [7:3]        */
...
void TMR1_Int1Notification (void)       __attribute__((weak,alias("_unexpected_interrupt")));
void TMR1_Int2Notification (void)       __attribute__((weak,alias("_unexpected_interrupt")));
void TMR1_Int3Notification (void)       __attribute__((weak,alias("_unexpected_interrupt")));
void TMR1_Int4Notification (void)       __attribute__((weak,alias("_unexpected_interrupt")));
void TMR1_Int5Notification (void)       __attribute__((weak,alias("_unexpected_interrupt")));

/*
 * Second level interrupt handlers
 */
static const Int_notificationFunctionType notificationFunctions[5] = {
    TMR1_Int1Notification,
    TMR1_Int2Notification,
    TMR1_Int3Notification,
    TMR1_Int4Notification,
    TMR1_Int5Notification   /* highest priority */
};
 ...
 *
 */
__interrupt__ void TIMER1_IRQ (void)
{
    uint16 pending;
