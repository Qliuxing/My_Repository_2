...
int16 g_i16PID_D = 0;
int16 g_i16PID_E = 0;
uint16 g_u16PID_CtrlCounter = 0;												/* 8: */
uint16 g_u16PID_ThrshldCtrlCounter = 0;											/* 5: */
...
#if _SUPPORT_AMBIENT_TEMP
				u16CurrThrshldRatio = (uint16) (muldivI16_I16byI16byI16( ((int16) u16CurrThrshldRatioEnd - (int16) u16CurrThrshldRatioBgn), (g_i16AmbjTemperature - i16TemperatureBgn), i16TemperatureEnd) + u16CurrThrshldRatioBgn);
#else  /* _SUPPORT_AMBIENT_TEMP */
