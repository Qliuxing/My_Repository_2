...
volatile uint16_t task2_v_pr __DPAGE__;
volatile uint16_t task2_v_tm __DPAGE__;

/** ----------------------------------------------------------------------------
 *
 *  Initialization
 */
void Task2_Init (uint16_t arg)
{
    cnt_pr = arg;
    cnt_tm = arg;
 ...
 *  Pressure DSP
 */
void Task2_DSP_ProcessPressure (uint16_t arg)
{
    cnt_pr = arg;
    cnt_pr++;
 ...
 *  Temperature DSP 
 */
void Task2_DSP_ProcessTemperature (uint16_t arg)
{
    cnt_tm = arg;
    cnt_tm++;
