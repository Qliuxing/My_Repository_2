...
#if LIN_VERSION >= 20
#define l_bool_wr_XXXResponse_ErrorXXX(n)	( l_bool_wr_doorFrontLeft_respError((n)) )
#define l_flg_clr_XXXResponse_ErrorXXX()	( l_flg_clr_doorFrontLeft_respError() )
#define l_flg_tst_XXXResponse_ErrorXXX()	( l_flg_tst_doorFrontLeft_respError() )
